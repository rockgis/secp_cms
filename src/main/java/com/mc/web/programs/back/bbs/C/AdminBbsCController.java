 ...
 */
@Controller
@RequestMapping(value="/super/bbs/C")
public class AdminBbsCController {
	
	@Autowired
	private AdminBbsCService service;
	...
	public List stateList(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		return service.stateList(params);
	}
