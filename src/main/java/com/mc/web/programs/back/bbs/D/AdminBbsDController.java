package com.mc.web.programs.back.bbs.D;
 ...
 */
@Controller
@RequestMapping(value="/super/bbs/D")
public class AdminBbsDController {
	
	@Autowired
	private AdminBbsDService service;
	...
	@Transactional(rollbackFor = { Exception.class })
	public Map reply(@RequestParam Map<String, Object> jsonObject) throws Exception{
		Map params = (JSONObject) JSONValue.parse((String)jsonObject.get("jData"));	//JSON으로 보내준 데이터를 사용
