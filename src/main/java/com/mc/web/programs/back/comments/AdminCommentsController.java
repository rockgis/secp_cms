...
public class AdminCommentsController {
	...
	@ResponseBody
	@RequestMapping("/super/comment_list.do")
	public Map comment_list(HttpServletRequest request, HttpSession session, @RequestParam Map<String, String> params) throws Exception{
		return service.list(params);
	}
	
	@ResponseBody
	@RequestMapping("/super/comment_reg.do")
	public Map comment_reg(@RequestParam Map<String, String> params) throws Exception {
		return service.comment_reg(params);
	}
	
	@ResponseBody
	@RequestMapping("/super/re_comment_reg.do")
	public Map re_comment_reg(@RequestParam Map<String, String> params) throws Exception {
		return service.re_comment_reg(params);
	}
	
	@ResponseBody
	@RequestMapping("/super/comment_del.do")
