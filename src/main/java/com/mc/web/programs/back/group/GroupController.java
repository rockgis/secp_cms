...
public class GroupController {
	...
	@ResponseBody
	@RequestMapping("/super/group/list.do")
	...
	@ResponseBody
	@RequestMapping("/super/group/view.do")
	...
	@ResponseBody
	@RequestMapping("/super/group/write.do")
	...
	@ResponseBody
	@RequestMapping("/super/group/modify.do")
	@Transactional(rollbackFor = { Exception.class })
	...
	@ResponseBody
	@RequestMapping("/super/group/del.do")
	@Transactional(rollbackFor = { Exception.class })
	...
	@ResponseBody
	@RequestMapping("/super/group/staffList.do")
	public List staffList(@RequestParam Map<String, String> params, HttpServletRequest request, HttpSession session) throws Exception{
		return service.staffList(params);
	}
	
	@ResponseBody
	@RequestMapping("/super/group/updateGroupStaff.do")
	@Transactional(rollbackFor = { Exception.class })
	public Map updateGroupStaff(HttpServletRequest request, HttpSession session, @RequestParam Map<String, Object> jsonObject) throws Exception{
		Map params = (JSONObject) JSONValue.parse((String)jsonObject.get("jData"));	//JSON으로 보내준 데이터를 사용
		return service.updateGroupStaff(params);
	}
