package com.mc.web.programs.front.biz003;
 ...
 * @ClassName   : com.mc.web.programs.biz003.Biz003Controller.java
 ...
 */
@Controller
public class Biz003Controller {
	
	@Autowired
	private Biz003Service service;
	
	@Autowired
	private ApplyService applyService;
	
	@RequestMapping(value="/biz003/intro.do")
	 ...
	 * @throws Exception
	 */
	@RequestMapping(value="/apply/biz003/index.do", method=RequestMethod.GET)
	public ModelAndView ptmEnv(HttpServletRequest request, @RequestParam Map<String, Object> params, ModelAndView model) throws Exception{
		...
		//model.setViewName(applyService.demoCost(params));
		model.setViewName("programs/biz003/index");
		return model;
	}
}
