	...
	<div class="ct_wrap">
		<div class="conwrap_tap">
			<ul>
				...
				<li class="on"><a href="${context_path }/super/homepage/bbs/index.do?cms_menu_seq={{param.cms_menu_seq}}&amp;parent_menu_seq={{param.parent_menu_seq}}&amp;permit={{param.permit}}" target="_self"><span>게시판관리</span></a></li>
			</ul>
		</div>
		<div class="contents">
			...
			<table class="type1" id="boardList">
				...
				<tr data-ng-repeat="item in board.notice_list">
					...
					<td class="left member_nm"><a data-my-href="/modify/{{param.board_type}}/{{item.article_seq}}">{{item.title}}<label data-ng-if="item.comment_cnt > '0'"> ({{item.comment_cnt }})</label><label data-ng-if="item.public_yn=='N'" style="margin-left: 5px;"><img src="/images/article/style01_mp.gif" alt="비공개"></label></a></td>
			...
			<div class="btn_bottom">
				<div class="r_btn" data-ng-if="param.del_yn == 'N' || param.del_yn == null">
			...
			<table class="type1">
		        ...
		        <tr>
	          	...
	          	<tr data-ng-repeat="item in board.list">
		            ...
		            <td class="center"><input type="button" class="shortcut" value="페이지 바로가기" ng-click="blankUrl(item.menu_url)"/></td>
		            <td class="center">
	            		<input type="button" value="삭제" class="bt_small_bt7" data-ng-click="del(item)">
	            	</td>
	          	</tr>
	        </table>
