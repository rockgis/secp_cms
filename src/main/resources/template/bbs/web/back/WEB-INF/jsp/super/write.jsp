		...
		<sec:csrfInput />
	      	<table class="type1" style="margin-top:0;">
	        	...
	        	<tr>
			        ...
			        <td>
			        	<ol class="select">
			        		<li><label><input type="radio" data-ng-model="form.notice_yn" value="N" data-ng-init="form.notice_yn = 'N'"/> 미사용</label></li>
			        		<li><label><input type="radio" data-ng-model="form.notice_yn" value="Y" /> 사용</label></li>			        		
			        	</ol>
			        	<div data-ng-if="form.notice_yn=='Y'" style="margin-top:4px;">
			        		<input type="text" class="normal w175" style="position:relative; z-index:100; margin-right:3px;" data-ng-model="form.edate" datetimepicker ng-disabled="form.notice_limit" required="required">
			        		<span style="margin-left:8px"><label><input type="checkbox" data-ng-model="form.notice_limit" value="Y" ng-click="none_limit()"/> 무기한</label></span>
			        	</div>
			        </td>
			    </tr>
	        	<tr data-ng-if="param.public_yn != 'Y'">
			        <th>비밀글</th>
			        <td>
	        	...
	        	<tr data-ng-if="param.cat_yn == 'Y'">
	          		<th>카테고리</th>
	          		<td>	            		
	            		<ol class="select" data-ng-init="form.cat = catlist[0].board_cat_seq">
			        		<li data-ng-repeat="item in catlist"><label><input type="radio" data-ng-model="form.cat" ng-value="item.board_cat_seq" /> {{item.cat_nm}}</label></li>
			        	</ol>
	          		</td>
	        	</tr>
	        	<tr>
