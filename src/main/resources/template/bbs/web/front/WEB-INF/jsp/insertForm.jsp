...
<%-- </c:if> --%>
		...
		<tr class="last">
			...
			<td id="fileList" class="border_none" colspan="3">
				<div id="file1">
					...
					<a href="javascript:fileListAdd()"><img src="/images/article/add_btn.gif" alt="파일 추가"/></a>
				</div>
			</td>
		</tr>
		</c:if>
	...
	<div class="btn_type1">
		<div class="right">
	  		<%-- <input type="image" style="vertical-align:top" src="<c:url value="/images/article/board_btn6.gif"/>" alt="등록"/> --%>
