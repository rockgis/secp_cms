...
<input type="hidden" name="card_yn" value="${boardInfo.card_yn }"/> --%>
	...
	<table class="write_style_1">
		...
		<tr>
			<th scope="row" class="contents">내용<br /><span>(2000자 입력가능)</span></th>
			<td colspan="3"><textarea name="conts" style="width:100%;" class="${boardInfo.editor_yn == 'Y' ? 'globalEditor' : ''}" title="내용입력">${view.conts }</textarea></td>
		</tr>
		...
		<tr class="last">
			...
			<td id="fileList" colspan="3">
				<div id="file1"><input type="file" id="file" name="attach" style="margin-bottom:5px;" title="첨부파일1"/> <a href="javascript:fileListAdd()"><img src="/images/article/add_btn.gif" alt="추가" /></a></div>
			</td>
		</tr>
		</c:if>
	...
	<div class="btn_type1">
		<div class="right">
	  		<%-- <input type="image" style="vertical-align:top" src="<c:url value="/images/article/board_btn6.gif"/>" alt="수정"/> --%>
