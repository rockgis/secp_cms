...
/**
 *
 * @Description : {{TITLE}} 템플릿 컨트롤러
 * @ClassName   : com.mc.web.page.{{SUB_NAME_LOWER}}.{{SUB_NAME_CAMEL}}TemplateController.java
 ...
 */
@Controller
@RequestMapping(value="{{SUB_PATH}}")
public class {{SUB_NAME_CAMEL}}TemplateController{
	Logger log = Logger.getLogger(this.getClass());
	
	@Resource(name="{{SUB_NAME_LOWER}}TemplateService")
