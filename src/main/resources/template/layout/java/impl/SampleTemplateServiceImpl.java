package com.mc.web.page.{{SUB_NAME_LOWER}}.impl;
...
import com.mc.web.page.{{SUB_NAME_LOWER}}.WebTemplateHelper;

import egovframework.com.cmm.util.EgovHttpRequestHelper;

/**
*
* @Description : {{TITLE}} 템플릿 구현클래스
* @ClassName   : com.mc.web.page.{{SUB_NAME_LOWER}}.impl.{{SUB_NAME_CAMEL}}TemplateService.java
...
*/
@Service("{{SUB_NAME_LOWER}}TemplateService")
public class {{SUB_NAME_CAMEL}}TemplateServiceImpl implements TemplateService{
	...
	@Resource(name="{{SUB_NAME_LOWER}}TemplateHelper")
	private {{SUB_NAME_CAMEL}}TemplateHelper helper;
	...
	private String rootPath = "{{SUB_PATH}}";
	...
	public String topmenu(Map<String, String> params) throws Exception {
		HttpServletRequest request = EgovHttpRequestHelper.getCurrentRequest();
