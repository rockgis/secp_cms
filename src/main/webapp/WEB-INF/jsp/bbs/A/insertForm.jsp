...
<script src="<c:url value="/lib/js/jquery.mc_editor.js"/>"></script>
...
<%-- </c:if> --%>
	...
	<table class="board_write">
		<caption>
			...
			<p>제목, 이름, 비밀번호, 카테고리, 내용(2000자 입력가능), 첨부파일, CCL, 공공누리, 태그 입력을 통해 글을 등록할 수 있습니다.</p>
		</caption>
		<colgroup>
			<col style="width:13%;"/>
			<col style="width:32%;"/>
		...
		<tr>
			...
			<td colspan="3"><textarea id="conts" name="conts" style="width:100%;height:350px;" class="${boardInfo.editor_yn == 'Y' ? 'globalEditor' : ''}"></textarea></td>
		</tr>
	...
	<div class="btn_area">
		<div class="right">
	  		<%-- <input type="image" style="vertical-align:top" src="<c:url value="/images/board/board_btn6.gif"/>" alt="등록"/> --%>
