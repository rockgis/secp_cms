...
<%-- </c:if> --%>
	...
	<table class="board_write">
		<caption>
			...
			<p>제목, 이름, 비밀번호, 내용(2000자 입력가능), 썸네일이미지, 첨부파일, CCL, 공공누리, 태그 입력을 통해 글을 등록할 수 있습니다.</p>
		</caption>
		<colgroup>
			<col style="width:13%;"/>
			<col style="width:32%;"/>
		...
		<tr>
			...
			<td><label for="member_nm"><input type="text" id="member_nm" name="member_nm"/></label></td>
		...
		<tr>
			...
			<td colspan="3"><textarea name="conts" style="width:100%;height:350px;" class="${boardInfo.editor_yn == 'Y' ? 'globalEditor' : ''}" title="내용입력"></textarea></td>
		</tr>
		
		<tr>
       		<th scope="row" rowspan="2">썸네일이미지 <b>*</b></th>
       		<td colspan="3">
