...
<input type="hidden" name="card_yn" value="${boardInfo.card_yn }"/> --%>
	...
	<table class="board_write">
		<caption>
			...
			<p>제목, 이름, 비밀번호, 카테고리, 내용(2000자 입력가능), 첨부파일, CCL, 공공누리, 태그 입력을 통해 글을 수정할 수 있습니다.</p>
		</caption>
		<colgroup>
			<col style="width:13;"/>
			<col style="width:32;"/>
		...
		<tr>
			...
			<td colspan="3"><textarea name="conts" style="width:100%;height:350px;" class="${boardInfo.editor_yn == 'Y' ? 'globalEditor' : ''}" title="내용입력">${view.conts }</textarea></td>
		</tr>
		...
		<tr class="lst">
			...
			<td id="fileList" colspan="3">
				<div id="file1"><input type="file" id="file" name="attach" style="margin-bottom:5px;" title="첨부파일1"/> <a href="javascript:fileListAdd()" class="btn_type_1"><img src="/images/board/add_btn.gif" alt="추가" /></a></div>
			</td>
		</tr>
		</c:if>
