...
<div class="btn_area">
	...
	<c:if test="${(sessionScope.member != null && sessionScope.member.member_id == view.reg_id) || view.password != null}">
		...
		<a class="v2" href="replyForm.do?article_seq=${view.article_seq }&amp;cpage=${suf:requestReplace(params.cpage , '')}&amp;rows=${suf:requestReplace(params.rows , '')}&amp;condition=${suf:requestReplace(params.condition , '')}&amp;keyword=${suf:requestReplace(params.keyword , '')}">답글등록</a>
