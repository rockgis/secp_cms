...
<div class="login_form">
	<form name="loginForm" id="loginForm" action="<c:url value='/loginProcess.do'/>" method="post">
		  <sec:csrfInput />
		  <input type="hidden" name="returnURL" value="/EgovContent.do"/>
		...
		<div class="login_input">
			<ul>
				...
				<li>
					...
					<input type="text" name="member_id" id="id" maxlength="10" title="${title} ${inputTxt}" placeholder="${title} ${inputTxt}">
				</li>
				<!-- 비밀번호 -->
				<c:set var="title"><spring:message code="comUatUia.loginForm.pw"/></c:set>
				<li>
					<label for="password">${title}</label>
					<input type="password" name="member_pw" id="password" maxlength="12" title="${title} ${inputTxt}" placeholder="${title} ${inputTxt}">
				</li>
				<!-- 아이디 저장 -->
