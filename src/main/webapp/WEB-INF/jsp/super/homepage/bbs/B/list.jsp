		...
		<div class="contents">
	    	...
	    	<div>
				...
				<table class="type1">
					...
					<tr ng-if="param.cat_yn=='Y'">
						<th>카테고리</th>
						<td>
							<select class="normal" title="카테고리" data-ng-model="param.cat" data-ng-options="item.board_cat_seq as item.cat_nm for item in catlist" data-ng-if="param.cat_yn == 'Y'">
			...
			<table class="type1" id="boardList">
				...
				<tr data-ng-repeat="item in board.list">
					...
					<td class="center">
						<label data-ng-if="item.notice_yn == 'Y'">
							<img src="/images/super/notice.png" alt="공지"/>
						</label>
						<label data-ng-if="item.notice_yn == 'N'">
							{{(board.totalCount|num) + 1 - (item.rn|num)}}
						</label>
					</td>
					<td class="center" data-ng-if="param.cat_yn == 'Y'">{{item.cat_nm}}</td>
					<td class="center"><img src="{{main.contextPath+item.thumb}}" style="width:100px;height:100px;"/></td>
