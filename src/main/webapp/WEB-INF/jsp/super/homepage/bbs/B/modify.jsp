	    	...
	    	<input type="hidden" data-ng-model="form.height" name="height" value="{{form.height}}"/>
	      	...
	      	<table class="type1" style="margin-top:0;">
	        	...
	        	<tr data-ng-if="param.cat_yn == 'Y'">
	          		<th>카테고리</th>
	          		<td>
	            		<select data-ng-model="form.cat" data-ng-options="item.board_cat_seq as item.cat_nm for item in catlist" required>
	            		</select>
	          		</td>
	        	</tr>
	        	<tr>
	        	...
	        	<tr>
	          		<th rowspan="2">썸네일이미지 <b class="essential">*</b></th>
	          		<td>
	          			<p style="margin-top:5px;color:#555; letter-spacing:-1px;">※ 썸네일 이미지는 리스트페이지에 보여지는 이미지를 등록 할 수 있습니다.<br>(썸네일 이미지를 등록하지 않으면 내용에 등록된 첫번째 이미지가 자동으로 보여집니다.)</p>
		  	...
		  	<div class="btn_bottom">
	        	...
	        	<div class="r_btn" data-ng-if="param.del_yn == 'Y'">
		          	<input type="button" value="완전삭제" class="bt_big_bt19" data-ng-click="db_delete_one(form.article_seq)"/>
		          	<input type="button" value="복원" class="bt_big_bt20" data-ng-click="restore_one(form.article_seq)"/>
		          	<input type="button" value="목록" class="bt_big_bt17" data-ng-click="list()"/>
	        	</div>
	      	</div>
		</form> 
