	    	...
	    	<input type="hidden" data-ng-model="form.height" name="height" value="{{form.height}}"/>
	      	...
	      	<table class="type1" style="margin-top:0;">
	        	...
	        	<tr data-ng-if="param.cat_yn == 'Y'">
	          		<th>카테고리</th>
	          		<td>
	            		<select class="normal" data-ng-model="form.cat" data-ng-options="item.board_cat_seq as item.cat_nm for item in catlist" data-ng-init="form.cat = catlist[0].board_cat_seq" required>
	            		</select>
	          		</td>
	        	</tr>
	        	<tr>
		  	...
		  	<div class="btn_bottom">
		        <div class="r_btn">
		        	<input type="button" value="예약적용" class="bt_big_bt2" data-ng-click="reserve()"/>
	          		<input type="button" value="등록" class="bt_big_bt2" data-ng-click="save()"/>
	          		<input type="button" value="목록" class="bt_big_bt4" data-ng-click="list()"/>
	        	</div>
	      	</div>
		</form>  
	    </div>
