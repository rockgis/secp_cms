			...
			<p><b class="essential">*</b> 표시는 필수 입력 입니다.</p>
	      	<table class="type1" style="margin-top:0;">
			    ...
			    <tr data-ng-if="param.cat_yn == 'Y'">
	          		<th>질문유형</th>
	          		<td>
	            		<select class="normal w175" data-ng-model="form.cat" data-ng-options="item.board_cat_seq as item.cat_nm for item in catlist" data-ng-init="form.cat = catlist[0].board_cat_seq" required>
	            		</select>
	          		</td>
	        	</tr>
	        	<tr>
	          		<th>상태</th>
	          		<td>
	            		<select class="normal w175" data-ng-model="form.state" data-ng-options="item.board_state_seq as item.state_nm for item in statelist" data-ng-init="form.state = statelist[0].board_state_seq" required>
	            		</select>
	          		</td>
	        	</tr>
	        	<tr>
