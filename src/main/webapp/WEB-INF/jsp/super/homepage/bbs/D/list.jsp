		...
		<div class="contents">
			...
			<table class="type1" id="boardList">
				...
				<tr data-ng-repeat="item in board.notice_list">
					...
					<td class="left member_nm"><any ng-bind-html="bindDepth(item.depth_num)"></any><a data-my-href="/modify/{{param.board_type}}/{{item.article_seq}}">{{item.title}}<label data-ng-if="item.comment_cnt > '0'"> ({{item.comment_cnt }})</label><label data-ng-if="item.public_yn=='N'" style="margin-left: 5px;"><img src="/images/board/style01_mp.gif" alt="비공개"></label></a></td>
			...
			<div class="btn_bottom">
				<div class="l_btn" style="float:left;" data-ng-if="param.del_yn == 'N' || param.del_yn == null">
				...
				<div class="l_btn" data-ng-if="param.del_yn == 'Y'">
