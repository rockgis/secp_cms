...
app.register.controller("listCtrl", function($scope, $timeout, $window, $routeParams, $location, $sce, ajaxService) {
	$scope.board = {
		chk_all : false
	};
	...
	ajaxService.getSyncJSON('<c:url value="/super/bbs/D/list.do"/>', $scope.param, function(data){
		$scope.board.notice_list = data.notice_list;
	...
	$scope.bindDepth = function(depth_num){
		var html = "";
		for(var i=0; i < depth_num; i++){
			html += "&nbsp;&nbsp;"; 
		}
