		...
		<div class="contents">
	    	...
	    	<div>
				...
				<table class="type1">
					...
					<tr>
						<th>검색구분</th>
						<td>
							<select data-ng-model="param.condition" id="condition" class="normal w125">
					...
					<tr ng-if="param.cat_yn=='Y'">
						<th>카테고리</th>
						<td>
							<select class="normal w125" title="카테고리" data-ng-model="param.cat" data-ng-options="item.board_cat_seq as item.cat_nm for item in catlist" data-ng-if="param.cat_yn == 'Y'">
					...
					<tr>
						<th>작성기간</th>
						<td>
							<input type="text" class="normal w125" style="position:relative; z-index:100; margin-right:3px;" data-ng-model="param.start_dt" datetimepicker date_max_model="param.end_dt">
							<span>~</span> 
							<input type="text" class="normal w125" style="position:relative; z-index:100; margin-right:3px;" data-ng-model="param.end_dt" datetimepicker date_min_model="param.start_dt">
						</td>
					</tr>
					<tr>
						<th>검색어</th>
						<td>
							<input type="text" class="normal w200" data-ng-model="param.keyword"/>
						</td>
					</tr>
					<tr>
				...
				<div style="overflow:hidden; margin-top:35px;">
			        ...
			        <div class="right_box_cms">
			        	<select class="normal w100" title="건별보기 선택" data-ng-model="param.rows">
							<option ng-value="10">10건씩보기</option>
			...
			<table class="type1" id="boardList">
				...
				<tr>
					...
					<th class="center" data-ng-if="param.cat_yn == 'Y'">카테고리</th>
				...
				<tr data-ng-repeat="item in board.notice_list">
					...
					<td class="left member_nm"><a data-my-href="/modify/{{param.board_type}}/{{item.article_seq}}">111{{item.title}}<label data-ng-if="item.comment_cnt > '0'"> ({{item.comment_cnt }})</label><label data-ng-if="item.public_yn=='N'" style="margin-left: 5px;"><img src="/images/board/style01_mp.gif" alt="비공개"></label></a></td>
				...
				<tr data-ng-if="board.list.length==0"><td colspan="{{(param.cat_yn == 'Y')?8:7}}" class="center">결과가 없습니다.</td></tr>
