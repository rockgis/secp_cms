...
<script type="text/javascript" src="<c:url value="/js/admin/biz003/introA.js"/>"></script>
				...
				<div class="f-left">
					<form name=f1 style=margin:0; onsubmit="return false;" >
						<select name="codeList" id="codeList" onchange="OnChange();">
							...
							<option selected value="C">3.첨부파일 업로드</option>
						</select>
						<button type="button" class="btn btn-darkblue">첨부파일 폴더지정</button>
					</form>
				</div>
				<div class="f-right">
