...
<div class="content-wrap">
	<div class="ct_wrap" style="width: 98%;height: 90%">
		...
		<div class="content-body">
			...
			<ul class="tab-menu">
				<li><a href="/super/homepage/biz001/indexC01.do" class="active">선정 대상 관리</a></li>
				<li><a href="/super/homepage/biz001/indexC03.do" >변경 신청 관리</a></li>
				...
				<div class="f-left">
					<form name=f1 style=margin:0; onsubmit="return false;" >
						<select name="codeList" id="codeList" onchange="OnChange();">
							...
							<option selected value="B">2.평가 결과 알림</option>
							<option value="C">3.사업 변경 신청 관리</option>
						</select>
						<button type="button" class="btn btn-mint">알림톡 보내기</button>
					</form>
