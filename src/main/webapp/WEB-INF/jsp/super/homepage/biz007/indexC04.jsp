...
<script type="text/javascript" src="<c:url value="/js/admin/biz007/introC.js"/>"></script>
...
<script type="text/javascript">
	...
	var columnLayout = [{
		...
		"headerText" : "견적서 1 첨부 서류",
		"children": [{
			"dataField": "CHANGE_PRQUDO_1",
			"headerText": "시공견적서",
			"editable": false,
			"style": "myLinkStyle",
		...
		"headerText" : "견적서 2 첨부 서류",
		"children": [{
			"dataField": "CHANGE_PRQUDO_2",
			"headerText": "시공견적서",
			"editable": false,
			"style": "myLinkStyle",
			// LinkRenderer 를 활용하여 javascript 함수 호출로 사용하고자 하는 경우
	...
	<div class="ct_wrap" style="width: 98%;height: 90%">
		...
		<div class="content-body">
			...
			<div class="f-clear mb30">
				<div class="f-left">
					<p>접수번호 : 202300101-00001   AAA 업체 (410-82-87398)</p>
					<form name=f1 style=margin:0; onsubmit="return false;" >
						...
						<button type="button" class="btn btn-mint" onclick="goto('/super/homepage/biz001/indexC03.do')">모두 조회</button>
						<button type="button" class="btn btn-mint" onclick="goto('/super/homepage/biz001/indexC04.do')">변경내역 대상 조회</button>
					</form>

				</div>
				<div class="f-right">
					<button type="button" class="btn btn-green" onclick="exportTo('pdf');">PDF 다운로드</button>
					<button type="button" class="btn btn-blue" >변경승인 </button>
				</div>
			</div>
