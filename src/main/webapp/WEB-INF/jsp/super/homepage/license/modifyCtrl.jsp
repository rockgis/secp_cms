...
app.register.controller("modifyCtrl", function($scope, $window, $routeParams, ajaxService, dialogService) {
	...
	ajaxService.getSyncJSON("<c:url value="/super/license/view.do"/>", {seq : $routeParams.seq}, function(data){
	...
	$scope.save = function(){
		...
		ajaxService.getJSON("<c:url value="/super/license/modify.do"/>", {jData : angular.toJson($scope.form)}, function(data){
			alert("저장되었습니다.");
			$scope.list();
		});
	}
