	...
	<div class="ct_wrap">
		...
		<sec:csrfInput />
	      	<table class="type1" style="margin-top:0;">
	        	...
	        	<tr>
	          		<th>빌드ID</th>
	          		<td>eGov{{form.issued_dt|myDate:'yyyyMMdd'}}-<input type="text" class="normal w75" style="width:100%" maxlength="5" value="자동생성" disabled="disabled"/></td>
	        	</tr>
	        	<tr>
	          		<th>버전</th>
	          		<td><input type="text" class="normal" style="width:100%" data-ng-model="form.version" required readonly="readonly"/></td>
	        	</tr>
	      	</table>
