...
app.register.controller("modifyCtrl", function($scope, $window, $routeParams, ajaxService, dialogService) {
	...
	ajaxService.getSyncJSON("<c:url value="/super/phistory/view.do"/>", {seq : $routeParams.seq}, function(data){
	...
	$scope.save = function(){
		...
		ajaxService.getJSON("<c:url value="/super/phistory/modify.do"/>", {jData : angular.toJson($scope.form)}, function(data){
			alert("저장되었습니다.");
			$scope.list();
		});
	}
