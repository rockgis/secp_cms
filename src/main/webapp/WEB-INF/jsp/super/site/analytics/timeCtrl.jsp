...
app.register.controller("timeCtrl", function($rootScope, $scope, $timeout, $window, $routeParams, $location, ajaxService, dialogService) {
	$scope.chart = {
		labels : [],
		colors : [],
	...
	$scope.getData = function(){
		ajaxService.getSyncJSON('<c:url value="/super/analytics/time.do"/>', $scope.param, function(data){
