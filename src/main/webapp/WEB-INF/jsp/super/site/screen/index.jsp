...
<body>
	<div class="titlebar">
		...
		<div>
			<span>사이트 관리</span>&gt;
			<span class="bar_tx">메인 이미지 관리</span>
		</div>
	</div>
	...
	<div class="contents_wrap" data-ng-controller="mainCtrl" data-ng-init="board.go(1)" >
		<div class="contents" data-ng-cloak>
		    ...
		    <div style="margin-top:20px;">
		    	<span class="bt_all"><span ng-class="{active:param.selecter==1}"><input type="button" value="메인이미지" class="btall" data-ng-click="param.selecter = 1;board.go(1);"/></span></span>
				<span class="bt_all"><span ng-class="{active:param.selecter==2}"><input type="button" value="팝업존" class="btall" data-ng-click="param.selecter = 2;board.go(1);"/></span></span>
				<span class="bt_all"><span ng-class="{active:param.selecter==3}"><input type="button" value="하단롤링" class="btall" data-ng-click="param.selecter = 3;board.go(1);"/></span></span>
		    </div>
		...
		<p style="text-align:right; margin-top:10px;"><b style="color:#c52409; font-family:"NanumBarunGothicB";">*</b>는 필수입력 입니다.</p>
      	<table class="type1" style="margin-top:0;">
			...
			<tr data-ng-if="form.selecter == '10'">
          		<th scope="row">레이어 위치 <b class="essential">*</b></th>
          		<td>
          			TOP : <input type="text" class="normal" data-ng-model="form.y_coord" style="width:35px;" required/> px &nbsp;&nbsp; / &nbsp;&nbsp; LEFT : <input type="text" class="normal" data-ng-model="form.x_coord" style="width:35px;" required/> px
          		</td>
        	</tr>
        	<tr>
...
<div class="contents" ng-controller="modifyCtrl" data-ng-cloak title="팝업 수정">
    ...
    <table class="type1" style="margin-top:0;">
		...
		<tr data-ng-if="form.selecter == '10'">
          	<th scope="row">레이어 위치</th>
          	<td>
          		TOP : <input type="text" class="normal" data-ng-model="form.y_coord" style="width:35px;" required/> px &nbsp;&nbsp; / &nbsp;&nbsp; LEFT : <input type="text" class="normal" data-ng-model="form.x_coord" style="width:35px;" required/> 
          	</td>
        </tr>
        <tr>
          	<th scope="row">기간 <b class="essential">*</b></th>
