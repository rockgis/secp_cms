	...
	<div class="contents_wrap">
		<div class="contents">
			...
			<table class="type1" style="margin-top:0;">
				<caption>게시판을 생성하는 페이지입니다. 게시판명, 게시판타입, 글목록개수 설정, SNS 댓글사용, 글등록버튼사용, 글자수제한, 비밀글 사용, 저작권보호 사용, 해시태그 사용, 파일등록, 통합검색여부, 사용여부, 카테고리 사용의 옵션을 제공합니다.</caption>
				<colgroup>
				...
				<tr>
					...
					<td><input type="text" class="normal w175" data-ng-model="form.board_nm" style="width:100%;" required/></td>
				</tr>
				<tr>
					<th scope="row">게시판타입</th>
					<td>
						<select class="normal w175" data-ng-model="form.board_type" data-ng-options="item.board_type as item.name for item in boardType" data-ng-change="stateAdd();" data-ng-init="form.board_type = boardType[0].board_type">
						</select>
					</td>
				</tr>
				<tr data-ng-if="form.board_type == 'B'">
			        ...
			        <td>
				        <ol class="select">
					        <li class="first"><label><input type="radio" data-ng-model="form.thumb_type" value="T" data-ng-init="form.thumb_type = 'T'"/> 타일</label></li>
			    ...
			    <tr>
			        ...
			        <td style="overflow:hidden;">
				        <ol class="select" style="float:left; margin:6px 0;">
				        	...
				        	<li class="first"><label><input type="radio" data-ng-model="form.insert_yn" value="Y" data-ng-init="form.insert_yn = 'Y'"/> 사용</label></li>
				        </ol>
				        <div style="float:left;" data-ng-show="form.insert_yn=='Y'" data-ng-disabled="form.board_type == 'E'">
					        <span style="margin-right:5px;">에디터 사용 여부</span>
					        <select class="normal" data-ng-model="form.editor_yn" data-ng-init="form.editor_yn = 'N'">
			    ...
			    <!-- <tr>
			    	...
			    	<td>
			    		<ol class="select" style="float:left; margin:6px 0;">
					        ...
					        <li class="first"><label><input type="radio" data-ng-model="form.limit_yn" value="Y" data-ng-init="form.limit_yn = 'Y'"/> 사용</label></li>
				        </ol>
			    ...
			    <tr>
			        ...
			        <td>
				        <ol class="select">
					        <li><label><input type="radio" data-ng-model="form.public_yn" value="Y" data-ng-init="form.public_yn = 'Y'" data-ng-disabled="form.board_type == 'E'"/> 사용안함</label></li>
			    ...
			    <tr>
			        ...
			        <td>
				        <ol class="select">
					        <li><label><input type="radio" data-ng-model="form.cclnuri_yn" value="N" data-ng-init="form.cclnuri_yn = 'N'" data-ng-disabled="form.board_type == 'E'"/> 사용안함</label></li>
			    ...
			    <tr>
			        ...
			        <td>
				        <ol class="select">
					        <li><label><input type="radio" data-ng-model="form.tag_yn" value="N" data-ng-init="form.tag_yn = 'N'" data-ng-disabled="form.board_type == 'E'"/> 사용안함</label></li>
			    ...
			    <tr id="agreeTr" style="display:none;">
			    	...
			    	<td>
			    		<ol class="select">
				        	<li style="text-align:center;"><label><img style="display:block; margin:0 auto 5px auto;" src="/images/super/regi_permit_n.gif" /><input type="radio" data-ng-model="form.agree_yn" value="N" data-ng-init="form.agree_yn = 'N'"  data-ng-change="useAgree();"/> 사용안함</label></li>
				        ...
				        <div class="regi_permit" data-ng-show="form.agree_yn=='Y'">
				        	...
				        	<div class="rp_wrap" data-ng-repeat="item in form.user_agree">
				        		...
				        		<div style="display:table-cell; padding:10px;">
				        			<input type="text" class="normal" name="user_agree_tit" data-ng-model="item.agree_tit" style="display:block; width:100%; margin-bottom:5px;" required />
				        			...
				        			<div style="overflow:hidden; margin-top:5px;">
					        			...
					        			<ol class="select" style="float:left; margin-left:10px;">
					        				<li><label for=""><input type="radio" data-ng-model="item.agree_check" value="Y" data-ng-init="item.agree_check = 'Y'" /> 필수</label></li>
			    ...
			    <tr>
					...
					<td style="overflow:hidden;">
						<ol class="select" style="float:left; margin:6px 0;">
							...
							<li class="first"><label><input type="radio" data-ng-model="form.file_yn" value="Y" data-ng-init="form.file_yn = 'Y'"/> 사용</label></li>
						</ol>
						<div style="float:left;">
							<label>
								<select class="normal" style="" data-ng-model="form.limit_file_size" data-ng-init="form.limit_file_size = 100">
			    ...
			    <tr>
			        <td>
				        <ol class="select">
					        <li class="first" style="line-height:24px;"><label><input type="radio" data-ng-model="form.file_limit" value="N" data-ng-init="form.file_limit = 'N'" data-ng-disabled="form.board_type == 'B'"/> 무제한</label></li>
				...
				<tr>
					...
					<td>
						<ol class="select">
							...
							<li class="first"><label><input type="radio" data-ng-model="form.search_yn" value="Y" data-ng-init="form.search_yn = 'Y'"/> 사용</label></li>
						</ol>
					</td>
				</tr>
				<tr>
				...
				<tr>
					...
					<td>
						<ol class="select">
							...
							<li class="first"><label><input type="radio" data-ng-model="form.cat_yn" value="Y" data-ng-init="form.cat_yn = 'N'" data-ng-change="catAdd();"/> 사용</label></li>
						</ol>
					</td>
				</tr>
						...
						<table class="type1">
							...
							<tbody id="catWrap">
								<tr data-ng-repeat="item in form.cat_size">
									<td class='member_nm left' style="padding-left:10px;">
										<input type="text" class="normal w200" data-ng-model="form.cat_nm[$index].cat_nm"/>
									</td>
									<td class='center'>
										<input type="button" data-ng-click="removeCat($index);" class="btalls" value="삭제"/>
									</td>
								</tr>
							</tbody>  
						</table>
				...
				<tr id="customTr" style="display:none;">
					...
					<td id="customTd">
						<b>컬럼은 재선택이 불가능 합니다.</b> <input type="button" value="항목추가" data-ng-click="addElement();" class="btalls"/>
						<br/>
						<div id="tables">
							<table data-ng-repeat="item in form.custom" class="type1" data-ng-init="item.order_num = $index" style="margin-bottom:10px;" data-index="{{$index}}" >
								<colgroup>
									<col style="width:10%;" />
									<col />
									<col style="width:15%;" />
								...
								<!-- 
								<tr>
									<th class="center" rowspan="5">{{item.order_num+1}}번 항목<br/>
										<input type="button" data-ng-click="removeElement($index);" value="삭제" class="btalls"/>
									</th>
									<th class="center">항목명/컬럼</th>
									<td colspan="5">
										<input type="checkbox" data-ng-model="item.element_check" data-ng-true-value="'Y'" data-ng-false-value="'N'"/>
										<input type="text" data-ng-model="item.element" required/> / 
										<select title="컬럼선택" data-ng-model="item.column_name" data-ng-options="item.col_code as item.col_kor for item in column_list" required>
											<option value="">전체</option>
										</select>
										<span data-ng-if="item.column_name != null" data-ng-repeat="cols in column_list|filter:{col_code:item.column_name}" style="color:blue;">{{cols.col_helper}}</span>
									</td>
								</tr>
								 -->
								<tr>
									<th scope="col" class="center" rowspan="6" >{{item.order_num+1}}번 항목<br/>
										<input type="button" data-ng-click="removeElement($index);" value="삭제" class="btalls"/>
									</th>
									<th scope="col" class="center" rowspan="2" style="border-left:solid 1px #ddd; border-right:solid 1px #ddd;">타이틀</th>
								...
								<tr>
									...
									<td class="center"><input type="text" class="normal" data-ng-model="item.element" required/></td>
									<td class="center">
										<select class="normal" title="컬럼선택" data-ng-model="item.column_name" data-ng-options="item.col_code as item.col_kor for item in column_list" required>
											<option value="">전체</option>
										</select>
									</td>
								...
								<tr>
									<th scope="col" class="center" rowspan="2" style="border-left:solid 1px #ddd; border-right:solid 1px #ddd;">사용자</th>
								...
								<tr>
									...
									<td class="center"><input type="text" class="normal" data-ng-model="item.user_list_col" data-ng-readonly="item.user_list_element == 'N'" value="{{item.user_list_element == 'N' ? '0%' : '10%'}}"/></td>
								...
								<tr>
									<th scope="col" class="center" rowspan="2" style="border-left:solid 1px #ddd; border-right:solid 1px #ddd;">관리자</th>
									<th scope="col" class="center">리스트(보임/숨김)</th>
									<th scope="col" class="center">리스트 사이즈(%,px)</th>
									<th scope="col" class="center">뷰(보임/숨김)</th>
									<th scope="col" class="center">쓰기(보임/숨김)</th>
								...
								<tr>
									...
									<td class="center"><input type="text" class="normal" data-ng-model="item.admin_list_col" data-ng-readonly="item.admin_list_element == 'N'" value="{{item.admin_list_element == 'N' ? '0%' : '10%'}}"/></td>
									<td class="center"></td>
