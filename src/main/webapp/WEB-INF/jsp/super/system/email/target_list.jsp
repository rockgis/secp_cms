	...
	<div class="contents" data-ng-init="board.go(1)" data-ng-cloak>
		...
		<table class="type1">
          	...
          	<tr data-ng-repeat="item in board.list">
	            ...
	            <td class="center">
	            	<button value="수정" class="bt_small modify" data-my-href="/target_modify/{{item.seq}}">수정</button>
		...
		<div class="btn_bottom">
	    	<div class="r_btn">
				<input type="button" value="등록" class="bt_big_bt4" data-my-href="/target_write""/>
	        </div>
	    </div>
	</div>
