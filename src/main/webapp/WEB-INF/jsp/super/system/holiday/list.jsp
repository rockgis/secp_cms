		...
		<div class="contents" data-ng-init="board.go(1)" data-ng-cloak>
			...
			<table class="type1" style="margin-top:0;">
				...
				<tr>
					<th scope="row">검색어</th>
					<td>
						<select title="공휴일 검색조건 선택" class="normal w100" data-ng-model="param.condition" data-ng-init="param.condition='title'">
				            <option value="title">공휴일명</option>
				            <option value="holiday">공휴일자</option>
				        </select>
			...
			<table class="type1">
	          	...
	          	<tr>
		            ...
		            <th scope="col" class="center">공휴일명</th>
		            <th scope="col" class="center">공휴일자</th>
		            <th scope="col" class="center">음력</th>
	          	...
	          	<tr data-ng-repeat="item in board.list">
		            ...
		            <td class="center member_nm">{{item.title}}</td>
		            <td class="center">{{item.holiday|myDate:'yyyy-MM-dd'}}</td>
		            <td class="center">{{(item.lunar_cal|myDate:'yyyy-MM-dd')||'-'}}</td>
		            <td class="center">
		            	<button value="수정" class="bt_small modify" data-my-href="/modify/{{item.holiday_seq}}">수정</button>
		            	<button value="" class="bt_small delete" data-ng-click="del(item)">삭제</button>
		            </td>
	          	</tr>
	        </table>
