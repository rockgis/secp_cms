		...
		<div class="contents" data-ng-init="board.go(1)" data-ng-cloak>
			...
			<div style="margin-top:35px;">
				<span class="bt_all">
					...
					<span data-ng-class="{active : param.gubun == 'B'}"><input type="button" style="padding:8px 30px;" value="게시판" data-ng-click="param.gubun='B';board.go(1);"/></span>
				</span>
		    </div>
			...
			<table class="type1">
		        ...
		        <tr>
	          	...
	          	<tr data-ng-repeat="item in board.list">
		            ...
		            <td class="center">
		            	<button class="bt_small move" value="페이지이동" ng-click="getLinkUrl(item)">페이지 이동</button>
		            </td>
		            <td class="center">
