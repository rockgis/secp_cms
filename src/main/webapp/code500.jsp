...
if(RequestSnack.isAjax(request)){
	...
	if("Y".equals(Globals.DEBUG)){
		json.put("debug", "Y");
		json.put("error_message", exception.getMessage());
	}else{
		json.put("debug", "N");
	}
	out.println(json);
        ...
        <td align="center"><table width="100%" border="0" cellspacing="9" cellpadding="0">
          <tr>
            <td bgcolor="#FFFFFF"><table width="100%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                <td align="center"><table width="520" border="0" cellspacing="2" cellpadding="2">
                  <tr>
                    ...
                    <td width="399" align="left" class="lt_text2">500 Internal Server error
                    <%
                    if("Y".equals(Globals.DEBUG)){
                		out.print("<br />에러내용 : "+exception.getMessage());
                	}
                    %>
                    </td>
                  </tr>
              ...
              <tr>
                <td align="center"><a href="javascript:fncGoAfterErrorPage();"><img src="${pageContext.request.contextPath}/images/egovframework/com/cmm/go_history.jpg" width="90" height="29" /></a></td>
              </tr>
            </table>
              <br /></td>
          </tr>
