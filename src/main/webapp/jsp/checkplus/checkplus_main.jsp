...
<%
    ...
    String sReturnUrl = "http://www.childsupport.or.kr/jsp/checkplus/checkplus_success.jsp";      // 성공시 이동될 URL
    String sErrorUrl = "http://www.childsupport.or.kr/jsp/checkplus/checkplus_fail.jsp";          // 실패시 이동될 URL
