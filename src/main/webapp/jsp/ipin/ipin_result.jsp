...
// 		out.println("고유번호 확인값 (CI) : " + sDupInfo + "<BR>");
...
//                 session.setAttribute("cprno", sCPRequestNum);
                ...
                if("01".equals(sReservedParam1)) {//회원가입
					%>
					...
					<%
				}else if("02".equals(sReservedParam1)){//아이디 찾기
					%>
             		<script language='javascript'>
						var memDI = "<%=sDupInfo %>";
					...
					<%
				}else if("03".equals(sReservedParam1)){//비밀번호 찾기
					%>
		     		<script language='javascript'>
						var memDI = "<%=sDupInfo %>";
					...
					<%
				}else if("04".equals(sReservedParam1)){//휴면계정
