...
<%
	...
	if(encrypt.equals(u_pass))
	{
			...
			{
				session.invalidate(); 
				result_sc = "<script>alert(NamoSELang.pe_wR);window.document.location.href='../index.html';</script>";
			}
			else
			{
		...
		result_sc = "<script>alert(NamoSELang.pe_AM);location.href='account_setting.jsp';</script>";
	}
