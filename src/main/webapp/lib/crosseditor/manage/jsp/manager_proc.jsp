...
<%
	...
	if(check){
		result_sc = "<script type='text/javascript' language='javascript'>alert(NamoSELang.pe_wR);window.document.location.href='manager_setting.jsp?Tab=" + detectXSSEx(request.getParameter("Tab")) + "';</script>";
	}
	else{
		result_sc = "<script>alert(NamoSELang.pe_sK+'" + fileName + "');history.back();</script> ";
	}
