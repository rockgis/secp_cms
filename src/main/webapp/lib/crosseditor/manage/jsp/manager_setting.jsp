...
<title>Namo CrossEditor : Admin</title>
	<script type="text/javascript">var pe_tn="pe_Iq"; </script>
...
<form method="post" id="adminSetForm" name="adminSetForm" action="manager_proc.jsp" onsubmit="return pe_v();">
			...
			<td class="pe_hW">
				...
				<table class="pe_nk">
					<tr>
						<td class="pe_apj">				
							<ul>
								<li class="pe_li pe_Ea"><input type="button" id="setting_base" value="" style="width:110px;height:28px;" class="pe_rv pe_gn" /></li>
								<li class="pe_li"><input type="button" id="setting_edit" value="" style="width:110px;height:28px;" class="pe_rv pe_gn" /></li>
								<li class="pe_li"><input type="button" id="setting_view" value="" style="width:110px;height:28px;" class="pe_rv pe_gn" /></li>
								<li class="pe_li"><input type="button" id="setting_ab" value="" style="width:110px;height:28px;" class="pe_rv pe_gn" /></li>
							</ul>
						
						</td>
					</tr>
					<tr>
						<td class="pe_jV pe_jD"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Jz"></span></font></td>
					</tr>
				</table>
			...
			<td class="pe_hW">
				<div id="pe_MY">
					<table class="pe_sH">
						<tr>
							<td>
								<table class="pe_eq"><tr><td class="pe_ha" colspan="3"></td></tr>
								</table>
							 
								<table class="pe_eq">
								
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HH"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HN"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_GK"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_CM"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<input type="text" id="ImageSavePath" class="pe_kK" name="ImageSavePath" value="<%=settingValue.get("ImageSavePath")%>" /> ex) http:// www.mysite.com/image
										</td>
									</tr>
									...
									<div id="pe_aax">
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HJ"></span></b></td>
										<td class="pe_fD"></td>
										<td >
											<table class="pe_eq">
												<tr>
													<td class="pe_dW"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_Js" value="real" /><span id="pe_DD"></span>
												...
												<tr>
													<td class="pe_dW"> &nbsp;&nbsp;
													<input type="radio" name="encodingStyle" id="pe_OW" value="trans" /><span id="pe_IB"></span>
													</td>
												</tr>
												<tr>
													<td class = "pe_eK" colspan="3"></td>
												...
												<tr>
													<td class="pe_dW"> &nbsp;&nbsp;
														<input type="radio" name="encodingStyle" id="pe_PD" value="random" /><span id="pe_Ls"></span>
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_HC"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW"> &nbsp;
											<input type="hidden" id="UploadFileSubDir" name ="UploadFileSubDir" value="<%=settingValue.get("UploadFileSubDir")%>" />
											<input type="radio" id="pe_Dx" name="pe_Rt" value="true" /><label for="pe_Dx"><span id="pe_IR"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_Ej" name="pe_Rt" value="false" /><label for="pe_Ej"><span id="pe_IA"></span></label>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ei"></span></b></td>
										<td class="pe_fD"></td>
										<td >
											<table class="pe_eq">
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_CB"></span></td>
													<td class="pe_fD"></td>
													<td class="pe_dW"><input type="text" id="Width" name="Width" class="pe_mw" maxlength="10" value="<%=settingValue.get("Width")%>" />
													px</td>
												</tr>
												<tr>
													<td class = "pe_eK" colspan="3"></td>
												...
												<tr>
													<td >&nbsp;&nbsp;<span id="pe_CN"></span></td>
													<td class="pe_fD"></td>
													<td class="pe_dW"><input type="text" id="Height" name="Height" class="pe_mw" maxlength="10" value="<%=settingValue.get("Height")%>" /> px
													</td>
												</tr>	
											</table>
										</td>
						...
						<tr>
							<td class="pe_jV pe_jD"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_KW"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_eq">
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ot"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_NG"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_JL"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Or"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Kr"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Jh"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ku"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Kn"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_LR"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_FO"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<input type="text" id="DocBaseURL" name="DocBaseURL" class="pe_kK" value="<%=settingValue.get("DocBaseURL")%>" /> ex) http://www.mysite.com/doc.html 
										</td>
									</tr>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Rp"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Px"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_MC"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_zw"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
						...
						<tr>
							<td class="pe_jV pe_jD"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_JJ"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_eq">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xL"><span id="pe_Cc"></span></b></td>
										<td class="pe_fD"></td>
										<td>
											<table class="pe_eq">
												<input type="hidden" name="UploadImageFileExtBlockList" value="<%=settingValue.get("UploadImageFileExtBlockList")%>" />
												<tr>
													<td class="pe_dW"><input type="checkbox" id="UploadImageFileExtBlockListChecked" <%=settingValue.get("UploadImageFileExtBlockListChecked")%>/><span id="pe_qg"></span></td>
												</tr>
												<tr>
													<td class="pe_dW"><textarea id="UploadImageFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadImageFileExtBlockListTextarea")%></textarea><br /><span id="pe_Ed"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_xL"></span></b></td>
										<td class="pe_fD"></td>
										<td>
											<table class="pe_eq">
												<input type="hidden" name="UploadFileExtBlockList" value="<%=settingValue.get("UploadFileExtBlockList")%>" />
												<tr>
													<td class="pe_dW"><input type="checkbox" id="UploadFileExtBlockListChecked" <%=settingValue.get("UploadFileExtBlockListChecked")%>/><span id="pe_qg"></span></td>
												</tr>
												<tr>
													<td class="pe_dW"><textarea id="UploadFileExtBlockListTextarea" cols="70" rows="2"><%=settingValue.get("UploadFileExtBlockListTextarea")%></textarea><br /><span id="pe_Ed"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_JN"></span></b></td>
										<td class="pe_fD"></td>
										<td >
											<table class="pe_eq">
												<input type="hidden" name="AttributeBlockList" value="<%=settingValue.get("AttributeBlockList")%>" />
												<tr>
													<td class="pe_dW"><input type="checkbox" id="AttributeBlockListChecked" <%=settingValue.get("AttributeBlockListChecked")%>/><span id="pe_qg"></span></td>
												</tr>
												<tr>
													<td class="pe_dW"><textarea id="AttributeBlockListTextarea" cols="70" rows="2"><%=settingValue.get("AttributeBlockListTextarea") %></textarea><br /><span id="pe_vF"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_JB"></span></b></td>
										<td class="pe_fD"></td>
										<td >
											<table class="pe_eq">
												<input type="hidden" name="TagBlockList" value="<%=settingValue.get("TagBlockList")%>" />
												<tr>
													<td class="pe_dW"><input type="checkbox" id="TagBlockListChecked" <%=settingValue.get("TagBlockListChecked")%>/><span id="pe_qg"></span></td>
												</tr>
												<tr>
													<td class="pe_dW"><textarea id="TagBlockListTextarea" cols="70" rows="2"><%=settingValue.get("TagBlockListTextarea") %></textarea><br /><span id="pe_vF"></span></td>
												</tr>	
											</table>
										</td>
									</tr>
						...
						<tr>
							<td class="pe_jV pe_jD"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Ja"></span></font></td>
						</tr>
						...
						<tr>
							<td>
								...
								<table class="pe_eq" >
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_JF"></span></b></td>
										<td class="pe_fD"></td>
										<td>
											<table class="pe_eq">
												<input type="hidden" name="Template" id="Template" value="<%=settingValue.get("Template")%>" />
												<tr>
													<td class="pe_dW"><input type="button" id="pe_aGx" value="+" onClick="pe_C(this)"/></td>
													<td class="pe_dW">&nbsp;</td>
													<td class="pe_dW">&nbsp;</td>
												</tr>
												<tr style="background-color:#B2EBF4;">
													<td class="pe_dW"><b>Title</b></td>
													<td class="pe_dW"><b>URL</b></td>
													<td class="pe_dW"><b>Encoding</b></td>
												</tr>
											...
											for(int i=0; i<TemplateListArr.length ; i++){
												...
												if(TemplateListArr[i] == null || TemplateListArr[i] == ""){
													...
													%>
														<tr>
															<td><input type="text"  name="pe_OI"  value="<%=templateName %>" style="width:100px"/></td>
															<td><input type="text"  name="pe_YB"  value="<%=templateUrl %>" style="width:320px"/></td>
															<td><input type="text"  name="pe_ZJ"  value="<%=templateEncoding %>" style="width:90px"/><input type="button" value="-" onclick="pe_b(this)"/></td>
					...
					<table class="pe_sH">
						<tr>
							<td>
								...
								<table class="pe_eq">
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_If"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_QR" class="color{hash:true,valueElement:'FontColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="FontColor" name="FontColor" value="<%=settingValue.get("FontColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_gW">
											<input type="button" class="pe_ge pe_gn" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_QR').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hg"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_NT"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Nj"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										...
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Oh"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW"><input type="checkbox" id="ReturnKeyActionBRChecked" <%=settingValue.get("ReturnKeyActionBRChecked")%>/><label for="ReturnKeyActionBR"><span id="pe_ND"></span></label></td>
									</tr>
									<tr>
										<td class="pe_eK" colspan="3"></td>
									</tr>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ro"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_PO"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_QL"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
								...
								<table class="pe_eq">
									<tr>
										<td class="pe_jV pe_jD"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_Cc"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Jk"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_RZ" class="color{hash:true,valueElement:'ImgLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="ImgLineColor" name="ImgLineColor" value="<%=settingValue.get("ImgLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_gW">
											<input type="button" class="pe_ge pe_gn" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_RZ').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
								...
								<table class="pe_eq">				
									<tr>
										<td class="pe_jV pe_jD"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_HO"></span></font></td>
									</tr>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Hp"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_QO" class="color{hash:true,valueElement:'TableLineColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableLineColor" name="TableLineColor" value="<%=settingValue.get("TableLineColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_gW">
											<input type="button" class="pe_ge pe_gn" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_QO').color.fromString('#000000');">
											</li>
											</ul></td>
											</tr>
											</table>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_NV"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<table>
											<tr>
											<td>
											<input type="text" id="pe_Ua" class="color{hash:true,valueElement:'TableBGColor',pickerFaceColor:'transparent',pickerFace:3,pickerBorder:0,pickerInsetColor:'black'}" style="width:20px;"></td>
											<td><input id="TableBGColor" name="TableBGColor" value="<%=settingValue.get("TableBGColor") %>"></td>
											<td style="padding-left:0px">
											<ul style="width:140px;">
											<li class="pe_gW">
											<input type="button" class="pe_ge pe_gn" value="default" style="width:80px;height:26px;" onclick="document.getElementById('pe_Ua').color.fromString('#FFFFFF');">
											</li>
											</ul></td>
											</tr>
											</table>
			...
			<td class="pe_hW">
				<div id="pe_Od">
					<table class="pe_sH">
						<tr>
							<td>
								...
								<table class="pe_eq">
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_LE"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Ps"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_FC"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<input type="text" id="Css" name="Css" class="pe_kK" value="<%=settingValue.get("Css")%>" />  ex) http://www.mysite.com/common.css 
										</td>
									</tr>
									<tr>
										<td class="pe_eK" colspan="3"></td>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_NL"></span></b>
										...
										<td >
											<table class="pe_eq">
												<tr>
													<td class="pe_sP">&nbsp;&nbsp;<span id="pe_Lc"></span></td>
													<td class="pe_fD"></td>
													<td class="pe_dW">
														<input type="text" id="outlinecolor" name="outlinecolor" class="pe_ss" value="" />  ex) #000000 or black 
													</td>
												</tr>
												<tr>
													<td class="pe_eK" colspan="3"></td>
												...
												<tr>
													<td class="pe_sP">&nbsp;&nbsp;<span id="pe_NA"></span></td>
													<td class="pe_fD"></td>
													<td class="pe_dW">
														<input type="text" id="innerlineColor" name="innerlineColor" class="pe_ss" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_eK" colspan="3"></td>
												...
												<tr>
													<td class="pe_sP">&nbsp;&nbsp;<span id="pe_GV"></span></td>
													<td class="pe_fD"></td>
													<td class="pe_dW">
														<input type="text" id="skinfontColor" name="skinfontColor" class="pe_ss" value="" />
													</td>
												</tr>
												<tr>
													<td class="pe_eK" colspan="3"></td>
												...
												<tr>
													<td class="pe_sP">&nbsp;&nbsp;<span id="pe_Kz"></span></td>
													<td class="pe_fD"></td>
													<td class="pe_dW">
														<input type="text" id="toolbarBackgroundColor" name="toolbarBackgroundColor" class="pe_ss" value="" />
													</td>
												</tr>
											</table>
										</td>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Kq"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<input type="hidden" id="CreateTab" name ="CreateTab" value="<%=settingValue.get("CreateTab")%>" />
											<input type="checkbox" id="pe_Co" name="pe_sk" value="0" /><label for="pe_Co"><span id="wysiwyg"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_zv" name="pe_sk" value="1" /><label for="pe_zv"><span id="html"></span></label>&nbsp;&nbsp;
											<input type="checkbox" id="pe_xC" name="pe_sk" value="2" /><label for="pe_xC"><span id="preview"></span></label>
										</td>
									</tr>
								</table>
						...
						<tr>
							<td class="pe_jV pe_jD"><font style="font-size:9pt;color:#FF9F4B;font-weight:bold;"><span id="pe_JW"></span></font></td>
						</tr>
						<tr>
							<td>
								<table class="pe_eq"><tr><td class="pe_ha" colspan="3"></td></tr>
								...
								<table class="pe_eq">
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Nm"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
						...
						<table class="pe_nk">
							<tr>
								<td>
									<table class="pe_eq">
										<tr>
											<td class="pe_eK" colspan="5"></td>
										</tr>
										<tr>
											<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Kc"></span></b></td>
											<td class="pe_fD"></td>
											<td>
												<table class="pe_eq">
													<tr>
														<td class="pe_ve" >&nbsp;&nbsp;<span id="pe_JM"></span></td>
														<td class="pe_fD"></td>
														<td class="pe_dW">
															<input type="text" id="AdminPageUserMenuIdInput" name="AdminPageUserMenuIdInput" class="pe_kK" value="" /> 
														</td>
													</tr>
													<tr>
														<td class="pe_eK" colspan="3"></td>
													...
													<tr>
														<td class="pe_ve">&nbsp;&nbsp;<span id="pe_IP"></span></td>
														<td class="pe_fD"></td>
														<td class="pe_dW">
															<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_HI" value="function" /><label for="pe_HI"><span id="pe_Iy"></span></label>&nbsp;&nbsp;<input type="radio" name="AdminPageUserMenuPlayKindRadio" id="pe_In" value="plugin" /><label for="pe_In"><span id="pe_Oj"></span></label>
														</td>
													</tr>
													<tr>
														<td class="pe_eK" colspan="3"></td>
													...
													<tr>
														<td class="pe_ve">&nbsp;&nbsp;<span id="pe_JU"></span></td>
														<td class="pe_fD"></td>
														<td class="pe_dW" height="50px">
															<input type="text" id="AdminPageUserMenuButtonImgPathInput" name="AdminPageUserMenuButtonImgPathInput" class="pe_kK" value="" />
													...
													<tr>
														<td class="pe_ve">&nbsp;&nbsp;<span id="pe_MZ"></span></td>
														<td class="pe_fD"></td>
														<td class="pe_dW">	
															<input type="text" id="AdminPageUserMenuTitleInput" name="AdminPageUserMenuTitleInput" class="pe_kK" value="" />
														</td>
													</tr>
												</table>
											</td>
											<td class="pe_fD"></td>
											<td style="text-align:center;vertical-align:middle;"><input type="button" id="pe_De" value="" class="" style="width:60px;height:60px;"/>
											</td>
										</tr>
										<tr>
											<td class="pe_eK" colspan="5"></td>
										...
										<tr>
											<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_NH"></span></b></td>
											<td class="pe_fD"></td>
											<td class="pe_dW" colspan="2">
												<div id="pe_arx">&nbsp;</div>
											</td>
										</tr>
										<tr>
					...
					<div id = "pe_eq">
						...
						<table class="pe_nk">	
							<tr>
								<td id="pe_Mn" class="pe_jD">
									
									<table>
										<tr>
											<td id="pe_apR">
												<span id="pe_Ln"></span>: <br>
												<div id="pe_Yp" >
													<span id="pe_xi"></span> <br> 
													<span id="pe_FT"></span><br>
													<span id="pe_Ax"></span><br>
												</div>
											</td>
											<td id="pe_aou">
											<span id="pe_LK"></span>:<br>
												<div id="pe_Qa" ></div>
											</td> 
											<td valign="bottom">
												<ul style="margin:0 auto;width:340px;">
													<li class="pe_gW">
														<input type="button" id="spacebar" value="" class="pe_ge pe_gn" style="width:80px;height:26px;" />
													</li>
													<li class="pe_gW"><input type="button" id="space" value="" class="pe_ge pe_gn" style="width:68px;height:26px;"></li>
													<li class="pe_gW"><input type="button" id="enter" value="" class="pe_ge pe_gn" style="width:66px;height:26px;"></li>
												</ul>
											</td>
										</tr>
										<tr>
					...
					<table class="pe_sH">
						<tr>
							<td>
								...
								<table class="pe_eq">
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_Kh"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<input type="text" id="DocTitle" name="DocTitle" class="pe_kK" value="<%=settingValue.get("DocTitle")%>" />
										</td>
									</tr>
									<tr>
										<td class="pe_eK" colspan="3"></td>
									...
									<tr>
										<td class="pe_dS">&nbsp;&nbsp;&nbsp;&nbsp;<b><span id="pe_GO"></span></b></td>
										<td class="pe_fD"></td>
										<td class="pe_dW">
											<input type="hidden" id="AccessibilityOption" name ="AccessibilityOption" value="<%=settingValue.get("AccessibilityOption")%>" />
											<input type="radio" id="pe_EY" name="pe_xD" value="0" /><label for="pe_EY"><span id="pe_Is"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_ET" name="pe_xD" value="1" /><label for="pe_ET"><span id="pe_Mq"></span></label>&nbsp;&nbsp;
											<input type="radio" id="pe_Fg" name="pe_xD" value="2" /><label for="pe_Fg"><span id="pe_Lh"></span></label>
										</td>
									</tr>
									<tr>
										<td class="pe_eK" colspan="3"></td>
