 ...
 */
(function(ang, $){
    var servicesApp = angular.module('boardRouteResolverServices', []);
        ...
        this.route = function (routeConfig) {
            ...
            var resolve = function (baseName, secure) {
                ...
                routeDef.templateUrl = function(param){
                	return routeConfig.getViewsDirectory()+"/"+param.type+"/"+baseName+'.do';
                };
                routeDef.controller = baseName+'Ctrl';
                routeDef.secure = (secure) ? secure : false;
                routeDef.resolve = {
                    load: ['$q', '$rootScope', function ($q, $rootScope) {
                    	board_type = $rootScope.param.board_type;
                        var dependencies = [routeConfig.getControllersDirectory()+"/"+$rootScope.param.board_type+"/"+baseName+'Ctrl.do'];
